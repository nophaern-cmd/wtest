...
function getStoryContent(name) {
  const storyContent = {
    'The big monster': {
      content: '一个关于大怪物的有趣故事，通过描述怪物的身体部位来认识身体和颜色相关的词汇。故事鼓励孩子们观察和描述。',
      points: ['认识身体部位词汇', '练习颜色描述', '提高观察能力']
    },
    'Lets play': {
      content: '一个互动性强的故事，讲述了孩子们一起玩耍的场景。通过故事了解日常动作和表达。',
      points: ['认识日常动作词汇', '练习表达请求', '培养社交能力']
    },
    'Peppas Christmas': {
      content: '佩佩一家的圣诞节故事，充满了节日的欢乐氛围。通过故事了解圣诞节的传统和习俗。',
      points: ['了解圣诞节文化', '认识节日词汇', '感受节日氛围']
    },
    'Scary, not scary': {
      content: 'RAZ分级绘本，讲述有些东西看起来很可怕，但实际上并不可怕。帮助孩子克服恐惧。',
      points: ['情绪管理', '勇敢面对未知', '反义词认知']
    },
    'Two': {
      content: 'RAZ分级绘本，关于数字二的概念。通过有趣的画面认识数字和数量。',
